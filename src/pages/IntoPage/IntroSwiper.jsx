                 ...
                 >
                    <Card variant="outlined" sx={{
                        ...
                        <Box sx={{
                            ...
                            <img style={{ width: '100%', height: '100%' }} src={kartinka1} alt="kartinka1" />
                        </Box>
                        <Box>
                            <Typography
                                sx={{
                            ...
                            >
                                HoneyMoney is an application that helps you to keep up eye on your wishes easily using banka.
                            </Typography>
                        </Box>
                        <Box sx={{
                            display: 'flex',
                            ...
                            <Button onClick={() => swiperRef.current.slideTo(3)}
                                variant="outlined"
                                color='secondary'
                                sx={{
                            ...
                            >Skip</Button>
                            <Button onClick={() => swiperRef.current.slideNext(200)}
                                variant="outlined"
                                sx={{
                ...
                >
                    <Card variant="outlined" sx={{
                        ...
                        >
                            ...
                            >
                                Banka is storage for your money, you can share it with your friend or even make it public.
                            </Typography>
                        </Box>
                        <Box sx={{
                            display: 'flex',
                ...
                >
                    <Card variant="outlined" sx={{
                        ...
                        >
                            ...
                            >
                                You can easily transform items from wishlist to your banka and adjust them!
                            </Typography>
                        </Box>
                        <Box sx={{
                            display: 'flex',
                ...
                >
                    <Card variant="outlined" sx={{
                        ...
                        >
                            ...
                            >
                                Your saves are save since you withdraw them and until you take them back. Go on and try!
                            </Typography>
                        </Box>
                        <Box sx={{
                            display: 'flex',
