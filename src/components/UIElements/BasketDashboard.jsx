...
import { get_owner_baskets } from '../../redux/basket/basketActions';
...
const BasketDashboard = () => {
  ...
  return (
    <Box sx={{ bgcolor: 'white', boxShadow: 1, borderRadius: 3, p: 2, color: 'black', marginLeft: 5, marginRight: 5, borderColor: "black", position: 'relative' }}>
      <Box sx={{ display: 'flex', flexWrap: 'wrap', minWidth: 300, minHeight: 500, justifyContent: (loading || error) ? 'center' : null, alignItems: (loading || error) ? 'center' : null }}>
