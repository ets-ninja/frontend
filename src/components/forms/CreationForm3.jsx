...
import { selectBasket, setPhotoTag } from '../../redux/basket/createBasketSlice';
    ...
    >
      ...
      <Stack spacing={3} sx={{ display: 'flex' }}>
        ...
        <Box sx={{ position: 'relative' }}>
          ...
          <TextField type="text" label="Image URL (16/9)" sx={{ml: '30px', width: '252px', mb: '23px'}}
          value={basket.photoTag} onChange={(e)=> dispatch(setPhotoTag(e.target.value))}/>
        </Box>
      </Stack>
    </Box>
  );
